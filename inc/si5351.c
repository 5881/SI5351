/*
 * si5351.cpp - Si5351 library for STM32 & Libopencm3 (2020)
 *
...
/*
 * si5351_init(uint8_t xtal_load_c, uint32_t ref_osc_freq, int32_t corr)
 *
...
uint8_t si5351_read(uint8_t regAddr) {
	uint8_t reg_val = 0;
	i2c_transfer7(SI5351_I2C,SI5351_BUS_BASE_ADDR, &regAddr,1,&reg_val,1);
	return reg_val;
	}
